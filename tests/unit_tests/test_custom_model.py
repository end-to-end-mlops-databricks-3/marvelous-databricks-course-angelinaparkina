...
# def test_prepare_features(mock_custom_wrapper: HotelReservationsModelWrapper) -> None:
...
#     client = MlflowClient()
#     model_name = f"{mock_custom_model.catalog_name}.{mock_custom_model.schema_name}.hotel_reservationss_model_custom"
